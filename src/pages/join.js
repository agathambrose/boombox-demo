...
export const Join = () => {
  return (
    <main className="container bg-purply min-h-screen min-w-full font-poppins">
      <Header />
      ...
      <div className="container flex flex-col md:flex-row justify-center items-center">
        ...
        <form className="bg-black text-white md:p-16 p-8 rounded-md flex flex-col w-11/12 md:w-5/12 items-center md:items-start mt-4">
          ...
          <input
            type="text"
            name="name"
            className="bg-black border-white border rounded-md w-8/12 md:w-full py-2 my-4"
          />
          ...
          <input
            type="submit"
            value="Join Now"
            className="bg-blue-600 hover:bg-blue-700 w-8/12 py-3 rounded-lg mt-4 md:w-full"
          />
        </form>
      </div>
