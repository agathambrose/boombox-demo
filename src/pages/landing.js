...
export const Landing = () => {
  return (
    <div className="bg-purply h-screen relative">
      <Header />
      ...
      <div className="md:flex md:justify-evenly px-10 md:px-0 pt-4 md:pt-0 items-center justify-center absolute left-8 mx-auto">
        <img src={Afro} alt="img" className="md:w-2/6 w-4/6 md:mt-6" />

        <div className="text-white py-3 ">
          <h2 className="md:text-6xl font-bold text-3xl md:mb-6 mb-2">
            Good music is happiness
          </h2>
          <p className="md:text-3xl leading-loose">
